...
import ru.mobileup.template.core.utils.toCompose
...
@Composable
private fun ValidationError.resolveText(): String {
    return when (this) {
        is StringDesc -> this.resolve()
        else -> error("Unsupported ValidationError type")
    }
}
