# Pokemon Power Calculator Test

Use this as the source example for unit tests, table cases, private case data, and exception
assertions.

```kotlin
package <package_name>.features.pokemons.domain
